...
def setup
  ...
  @recipe2 = @chef.recipes.build(name: "chicken saute", description: "greate checken dish")
  @recipe2.save
end
  ...
  test "create new valid recipe" do
    ...
    description_of_recipe = "add chicken, add vegetaebles, cook for 20 minutes. serve delicious meal"
